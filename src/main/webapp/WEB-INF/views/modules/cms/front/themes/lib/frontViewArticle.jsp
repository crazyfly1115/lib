...
<div class="columns details">
	...
	<div class="middle">
		...
		<div class="container main">
			<div class="main-left">
				<div class="main-left-title">${category.name} <span></span></div>
			</div>
			<div class="main-content">
				<div id="content" tabindex="5000" class="scrollable">
					<p style="box-sizing: border-box; margin-top: 0px; margin-bottom: 10px; text-align: center; text-indent: 2em;font-size:24px;">
						${article.title}
					</p>
